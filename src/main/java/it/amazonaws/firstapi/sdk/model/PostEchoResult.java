...
public class PostEchoResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public PostEchoResult empty(Empty empty) {
        setEmpty(empty);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PostEchoResult == false)
            return false;
        PostEchoResult other = (PostEchoResult) obj;
    ...
    @Override
    public PostEchoResult clone() {
        try {
            return (PostEchoResult) super.clone();
